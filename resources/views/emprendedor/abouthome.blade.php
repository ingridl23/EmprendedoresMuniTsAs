    ...
    <div class="row gx-4 gx-lg-5 justify-content-center">
        <div class="col-lg-8 text-center">
            ...
            <p class="text-white-75 mb-4">
                ...
                Personas o colectivos que promuevan productos o servicios vinculados a la identidad local. Proyectos que
                reflejen valores culturales, artísticos o comunitarios.</li>
