    ...
    <div class="footer-top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-info">
                        ...
                        <div class="social-links mt-3">
                            ...
                            <a href="https://api.whatsapp.com/send/?phone=5492983509001&text&type=phone_number&app_absent=0"
                ...
                <div class="col-lg-2 col-md-6 footer-links">
                    ...
                    <ul>
                        <li><i class="bx bx-chevron-right"></i> <a href="https://www.tresarroyos.gov.ar/">Home</a></li>
                        <!--li><i class="bx bx-chevron-right"></i> <a href="#">Conocenos un poco</a></li-->
                        <li><i class="bx bx-chevron-right"></i> <a href="https://centrodesaludtsas.com.ar/"
                                target="_blank">Salud</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a
                                href="https://centrodesalud.com.ar/noticia/anotate-para-donar" target="_blank">Dona
                                sangre</a></li>

                        <li><i class="bx bx-chevron-right"></i> <a href="https://tresarroyos.itconsultsa.com/login"
                                target="_blank">Telemedicina</a></li>
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    ...
                    <div class="col-lg-4 col-md-6 footer-newsletter">
                        ...
                        <a class="  register-button"
                            href="https://www.whatsapp.com/channel/0029VaNtxbS77qVaO8CjH32K">Suscribirme
                        </a>
        ...
        <div class="container">
            ...
            <div class="credits">
                ...
                Creado por <a href="https://bootstrapmade.com/">Centro de Computos</a>
            </div>
        </div>
</footer>
<!-- End Footer -->
