...
<div class=" container-programas ">
    ...
    <div class="programas">
        ...
        <ul>
            ...
            <li>Ampliar la base emprendedora mediante actividades de sensibilización y promoción para diversos públicos.
            </li>
            ...
            <li>Acompañar y orientar a personas con ideas o proyectos en marcha, ofreciendo una escucha activa y guía
        ...
        <ul>
            ...
            <li>Participación en la Mesa de Emprendedores:
                Reuniones periódicas con otros miembros activos para compartir ideas, planificar acciones y acceder a
                información relevante.</li>
            <li>Acceso y planificación de Ferias de Emprendedores:
                Oportunidad de formar parte de la organización y exposición en ferias locales para dar visibilidad a los
                proyectos.</li>
            <li>Asesoramiento en habilitación comercial:
                Contacto directo con autoridades municipales para gestionar correctamente la habilitación de comercios.
            </li>
    ...
    <div class="programas">
        ...
        <p class="text-clubs">
            La Escuela de Emprendedores es un programa diseñado para formar, asesorar y acompañar a quienes están
            iniciando
            o quieren profesionalizar su emprendimiento.

            Esta iniciativa busca generar un espacio de intercambio, brindando herramientas prácticas para la gestión de
    ...
    <div class="programas">
        ...
        <p class="text-clubs">La Feria del Parque Cabañas es una propuesta organizada por el Club de Emprendedores, bajo
            la
            coordinación de la
    ...
    <p class="text-clubs">Desde la Oficina de Empleo, articulamos con programas nacionales y municipales para brindar
    ...
    <div class="programas">
        ...
        <p class="text-clubs">Permite que las empresas entrenen aprendices en puestos reales, sin establecer relación
            laboral formal,
    ...
    <div class="programas">
        ...
        <p class="text-clubs">Brinda acompañamiento personalizado a personas con discapacidad para que puedan acceder a
