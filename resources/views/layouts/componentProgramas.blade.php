...
<div class="container-programas">
    ...
    <div class="programas">
            ...
            <div id="portfolio">
                ...
                <section class="page-section text-white" id="SeccionFotosEmprendedores">
                    <div class="container px-4 px-lg-5 text-center">
                        ...
                        <a class="btn btn-light " href="{{ url('/emprendedores') }}">Ver más</a>
                    </div>
                </section>
            </div>
        ...
        <div class="programas">
            ...
            <div id="carouselCapacitacionEmprendedores" class="carousel slide carrousel" data-bs-ride="carousel">
                ...
                <button class="carousel-control-prev" type="button"
                    data-bs-target="#carouselCapacitacionEmprendedores" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
        ...
        <div class="programas">
            ...
            <p class="text-clubs">La Feria del Parque Cabañas es una propuesta organizada por el Club de
                ...
                en un entorno natural y accesible para toda la comunidad.
            </p>
    ...
    <div class="detallesClub  beneficiosDetallesClub">
        ...
        <ul class="estiloLista">
            <div>
                <li>No figurar en Registro Público de Empleadores con Sanciones Laborales (REPSAL)</li>
            </div>
        </ul>
    </div>
