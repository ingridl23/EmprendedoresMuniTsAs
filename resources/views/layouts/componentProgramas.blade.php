                ...
                <div class="row g-0">
                    ...
                    <div class="programas">
                        ...
                        <img class="img-fluid imagen-escuela"
                            src="{{ asset('assets/img/logoescuelaemprendedores.png') }}" alt="..." />
                        ...
                        <p class="text-clubs">
                            La Escuela de Emprendedores es un programa diseñado para formar, asesorar y acompañar a
                            quienes
                            están
                            iniciando
                            o quieren profesionalizar su emprendimiento.

                            Esta iniciativa busca generar un espacio de intercambio, brindando herramientas prácticas
                            para la
                            gestión de
                    ...
                    <div class="programas">
                        ...
                        <div id="carouselExampleInterval" class="carousel slide carrousel" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img src="{{ asset('public/assets/img/emprendedoresferiaadaptadas/7.jpg') }}"
                                        class="d-block w-100" alt="...">
                                </div>
                    ...
                    <p class="text-clubs">Desde la Oficina de Empleo, articulamos con programas nacionales y
                        municipales
                        para
                        brindar
