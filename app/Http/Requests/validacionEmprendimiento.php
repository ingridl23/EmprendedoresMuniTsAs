...
class validacionEmprendimiento  extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'imagenes.*.mimes' => 'Las imágenes deben ser del formato: jpeg, png, jpg, gif, svg o webp.',
            'imagenes.*.max' => 'Cada imagen no debe pesar más de 2MB.',
            'imagenes.*.dimensions' => 'Cada imagen no debe superar los 1920px de ancho y 1080px de alto.',
